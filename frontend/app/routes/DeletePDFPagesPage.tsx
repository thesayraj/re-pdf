...
const DeletePDFPagesPage: React.FC = () => {
  ...
  const applyChanges = async () => {
    try {
      ...
      const obj = await handleTask(items, "delete-pdf-pages", { pages: pages });
    ...
    <div className="pt-34 flex flex-col items-center p-8 bg-gray-50">
      <div className="w-full">
        ...
        <p className="text-gray-600 mb-8 text-center">
          Delete pages from your PDF documents seamlessly.
        </p>
      ...
      <div className="mt-40 space-y-4">
        ...
        <ol className="list-decimal list-inside text-gray-600 space-y-1">
          ...
          <li>
            Start deleting pages from UI by hovering over pages and clicking{" "}
            <i>
              <b>delete</b>
            </i>{" "}
            icon.
          </li>
          <li>Click "Apply Changes" to start the deletion process.</li>
