...
const RearrangePDFPagesPage: React.FC = () => {
  ...
  const applyChanges = async () => {
    try {
      ...
      const obj = await handleTask(items, "rearrange-pdf-pages", {
        pages: pages,
      });
    ...
    <div className="pt-34 flex flex-col items-center p-8 bg-gray-50">
      <div className="w-full">
        ...
        <p className="text-gray-600 mb-8 text-center">
          Easily drag and drop pages to reorder your PDF.
        </p>
      ...
      <div className="mt-40 space-y-4">
        ...
        <ol className="list-decimal list-inside text-gray-600 space-y-1">
          ...
          <li>Click “Apply Changes” to confirm your new page arrangement.</li>
...
export default RearrangePDFPagesPage;
